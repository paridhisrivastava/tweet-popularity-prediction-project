# Script from http://www.curiositybits.com/new-page-3/
# Credit to: Gregory Saxton and Weiai Wayne Xu
# Modified for use by Aditya S Murthy, Paridhi Srivastava and Vatsala Singh, RIT
# Needs python 2.7
...
t = Twython(app_key='Uxwzhs6DExpgsS0wJgrnOLq6X',       #REPLACE 'APP_KEY' WITH YOUR APP KEY, ETC., IN THE NEXT 4 LINES
    app_secret='d4xZ4iVNUUbZCnmHSBPHXtWu03OGDWCb04XBSvxLj4OEiJlgOJ',
    oauth_token='706555079139028992-qzCaTi5eC0XiYFq7Pl4wC2miMfXVwYK',
    oauth_token_secret='uLPoNuwKAdZNg59b9ZJajKxyzpJcLZRleFUjUOZiL9p1h')
...
class Scrape:
    def __init__(self):    
        engine = sqlalchemy.create_engine("sqlite:///E:\Aditya\RIT Semester 2\Intelligent Systems\Project\Data\Twitter20.sqlite", echo=False)  # different DB name here
